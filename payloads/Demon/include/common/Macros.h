...
#define NtGetLastError()                ((INSTANCE *)Instance)->Teb->LastErrorValue
#define NtSetLastError(x)               ((INSTANCE *)Instance)->Teb->LastErrorValue = x

/* Heap allocation functions */
#define NtProcessHeap()                 ((INSTANCE *)Instance)->Teb->ProcessEnvironmentBlock->ProcessHeap
...
#define DATA_FREE( d, l ) \
    if ( d ) { \
        MemSet( d, 0, l ); \
        ((INSTANCE *)Instance)->Win32.LocalFree( d ); \
        d = NULL; \
    }
